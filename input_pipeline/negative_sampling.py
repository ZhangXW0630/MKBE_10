...
def negative_sampling_aligned(batch, hyperparams, idenc, titles):
    ...
    return pos_age, neg_age, pos_gender, neg_gender, pos_occupation, neg_occupation, pos_zip, neg_zip, pos_title, \
           neg_title, pos_date, neg_date, pos_genre, neg_genre, pos_rating, neg_rating
...
def aggregate_sampled_batch(batch):
    ...
    neg_title, pos_date, neg_date, pos_genre, neg_genre, pos_movierating, neg_movierating = batch
